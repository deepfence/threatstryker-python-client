...
T = TypeVar("T", bound="ModelCloudAccountRefreshReq")


@_attrs_define
class ModelCloudAccountRefreshReq:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_cloud_account_refresh_req = cls(
            node_ids=node_ids,
        )

        model_cloud_account_refresh_req.additional_properties = d
        return model_cloud_account_refresh_req
