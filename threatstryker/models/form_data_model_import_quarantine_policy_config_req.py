...
class FormDataModelImportQuarantinePolicyConfigReq:
    ...
    Attributes:
        config_id (str):
        quarantine_policy_json (Optional[File]):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        quarantine_policy_json = self.quarantine_policy_json.to_tuple() if self.quarantine_policy_json else None
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _quarantine_policy_json = d.pop("quarantine_policy_json")
        quarantine_policy_json: Optional[File]
        if _quarantine_policy_json is None:
            quarantine_policy_json = None
        else:
            quarantine_policy_json = File(payload=BytesIO(_quarantine_policy_json))
