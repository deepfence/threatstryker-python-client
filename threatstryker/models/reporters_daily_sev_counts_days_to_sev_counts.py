...
T = TypeVar("T", bound="ReportersDailySevCountsDaysToSevCounts")


@_attrs_define
class ReportersDailySevCountsDaysToSevCounts:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        reporters_daily_sev_counts_days_to_sev_counts = cls()
        ...
        reporters_daily_sev_counts_days_to_sev_counts.additional_properties = additional_properties
        return reporters_daily_sev_counts_days_to_sev_counts
