...
class ModelScanCompareResGithubComDeepfenceThreatMapperDeepfenceServerModelCompliance:
    ...
    Example:
        {'new': [{'resource': 'resource', 'masked': True, 'description': 'description', 'resources': ['resources',
            ...
            'compliance_check_type': 'compliance_check_type', 'rule_id': 'rule_id', 'test_rationale': 'test_rationale',
            ...
            'test_desc': 'test_desc', 'test_number': 'test_number'}, {'resource': 'resource', 'masked': True, 'description':
            'description', 'resources': ['resources', 'resources'], 'test_category': 'test_category', 'remediation_ansible':
