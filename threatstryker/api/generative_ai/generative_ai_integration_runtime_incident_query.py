...
from ...models.model_generative_ai_integration_runtime_incident_request import (
...
def _get_kwargs(
    *,
    json_body: ModelGenerativeAiIntegrationRuntimeIncidentRequest,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/deepfence/generative-ai-integration/query/alert",
        "json": json_json_body,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (ModelGenerativeAiIntegrationRuntimeIncidentRequest):  Example: {'summary':
