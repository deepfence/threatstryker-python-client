...
from ...models.model_generative_ai_integration_secret_request import ModelGenerativeAiIntegrationSecretRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/generative-ai-integration/query/secret",
    }
