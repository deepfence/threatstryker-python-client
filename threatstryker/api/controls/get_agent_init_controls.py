...
from ...models.model_init_agent_req import ModelInitAgentReq
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/controls/agent-init",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ControlsAgentControls.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, ControlsAgentControls]
    """
