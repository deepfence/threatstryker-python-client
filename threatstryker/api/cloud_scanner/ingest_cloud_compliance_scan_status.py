...
from ...models.ingesters_cloud_compliance_scan_status import IngestersCloudComplianceScanStatus
from ...types import Response


def _get_kwargs(
    *,
    body: Union[None, list["IngestersCloudComplianceScanStatus"]],
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/ingest/cloud-compliance-status",
    }
