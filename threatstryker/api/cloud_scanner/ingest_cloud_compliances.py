...
from ...models.ingesters_cloud_compliance import IngestersCloudCompliance
from ...types import Response


def _get_kwargs(
    *,
    body: Union[None, list["IngestersCloudCompliance"]],
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/ingest/cloud-compliance",
    }
