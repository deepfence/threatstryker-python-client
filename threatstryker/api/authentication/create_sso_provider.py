...
from ...models.singlesignon_sso_provider_config import SinglesignonSSOProviderConfig
from ...types import Response


def _get_kwargs(
    *,
    json_body: SinglesignonSSOProviderConfig,
) -> Dict[str, Any]:
    pass
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (SinglesignonSSOProviderConfig):  Example: {'issuer_url': 'issuer_url',
            'sso_provider_type': 'oidc', 'disable_password_login': True, 'client_secret':
