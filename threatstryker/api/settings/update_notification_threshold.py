...
from ...models.model_notification_threshold_update_request import ModelNotificationThresholdUpdateRequest
from ...types import Response


def _get_kwargs(
    *,
    json_body: ModelNotificationThresholdUpdateRequest,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/deepfence/license/notification-threshold",
        "json": json_json_body,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (ModelNotificationThresholdUpdateRequest):  Example:
