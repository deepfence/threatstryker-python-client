...
from ...models.diagnosis_generate_console_diagnostic_logs_request import DiagnosisGenerateConsoleDiagnosticLogsRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/diagnosis/console-logs",
    }
