...
from ...models.diagnosis_diagnostic_notification import DiagnosisDiagnosticNotification
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = DiagnosisDiagnosticNotification.from_dict(response_200_item_data)
