...
from ...models.controls_agent_beat import ControlsAgentBeat
from ...models.report_raw_report import ReportRawReport
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ControlsAgentBeat.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, ControlsAgentBeat]
    """
