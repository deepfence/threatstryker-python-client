...
from ...models.ingest_agent_alerts_body_type_0_item import IngestAgentAlertsBodyType0Item
from ...types import Response


def _get_kwargs(
    *,
    body: Union[List["IngestAgentAlertsBodyType0Item"], None],
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/ingest/alerts",
    }
...
def sync_detailed(
    *,
    ...
    """Ingest Agent Alerts
     ...
     Ingest alerts data reported by one Agent
