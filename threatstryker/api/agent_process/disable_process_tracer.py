...
def _get_kwargs(
    *,
    body: ModelDisableTracerReq,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/process/tracer/disable",
    }
...
def sync_detailed(
    *,
    ...
    """Disable process tracer
     ...
     Disable process tracer on given agents

    Args:
        body (ModelDisableTracerReq):  Example: {'agent_ids': [{'node_type': 'node_type',
