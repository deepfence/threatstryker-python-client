...
from ...models.model_delete_filter import ModelDeleteFilter
from ...types import Response


def _get_kwargs(
    *,
    json_body: ModelDeleteFilter,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/deepfence/remove/quarantine-violations",
        "json": json_json_body,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (ModelDeleteFilter):  Example: {'node_ids': ['node_ids', 'node_ids']}.
