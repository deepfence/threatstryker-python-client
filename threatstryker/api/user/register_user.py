...
def _get_kwargs(
    *,
    json_body: ModelUserRegisterRequest,
) -> Dict[str, Any]:
    pass
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (ModelUserRegisterRequest):  Example: {'password': 'password', 'console_url':
            'console_url', 'namespace': 'namespace', 'last_name': 'last_name', 'company': 'company',
