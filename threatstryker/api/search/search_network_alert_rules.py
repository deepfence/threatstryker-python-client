...
from ...models.model_network_alert_rule import ModelNetworkAlertRule
...
def _get_kwargs(
    *,
    ...
    return {
        "method": "post",
        "url": "/deepfence/search/network-alert-rules",
        "json": json_json_body,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ModelNetworkAlertRule.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    """Search network alert rules
     ...
     Search across all data associated with network alert rules
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, List['ModelNetworkAlertRule']]
    """
