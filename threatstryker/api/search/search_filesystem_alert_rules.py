...
from ...models.model_filesystem_alert_rule import ModelFilesystemAlertRule
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/search/file-alert-rules",
    }
...
) -> Optional[Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, List["ModelFilesystemAlertRule"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelFilesystemAlertRule.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, List["ModelFilesystemAlertRule"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Search file system alert rules

     Search across all data associated with file system alert rules
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, List['ModelFilesystemAlertRule']]
    """
