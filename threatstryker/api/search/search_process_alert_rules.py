...
from ...models.model_process_alert_rule import ModelProcessAlertRule
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/search/process-alert-rules",
    }
...
) -> Optional[Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, List["ModelProcessAlertRule"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelProcessAlertRule.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, List["ModelProcessAlertRule"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Search process alert rules

     Search across all data associated with Process alert rules
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ApiDocsBadRequestResponse, ApiDocsFailureResponse, List['ModelProcessAlertRule']]
    """
