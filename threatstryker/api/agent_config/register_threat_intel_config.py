    ...
    *,
    ...
    Args:
        json_body (ControlsThreatIntelInfo):  Example: {'updated_at': 0,
            'network_alert_rules_url': 'network_alert_rules_url', 'ignored_alert_rule_ids':
            ['ignored_alert_rule_ids', 'ignored_alert_rule_ids'], 'internal_ips': ['internal_ips',
            'internal_ips'], 'rules_hash': 'rules_hash'}.
