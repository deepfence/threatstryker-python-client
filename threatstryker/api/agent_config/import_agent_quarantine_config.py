...
from ...models.form_data_model_import_quarantine_policy_config_req import FormDataModelImportQuarantinePolicyConfigReq
...
def _get_kwargs(
    *,
    multipart_data: FormDataModelImportQuarantinePolicyConfigReq,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/deepfence/configs/agent/quarantine/import",
