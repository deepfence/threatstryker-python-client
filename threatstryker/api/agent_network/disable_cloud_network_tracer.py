...
from ...models.model_disable_cloud_tracer_req import ModelDisableCloudTracerReq
from ...types import Response


def _get_kwargs(
    *,
    body: ModelDisableCloudTracerReq,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/network/cloud-tracer/disable",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (ModelDisableCloudTracerReq):  Example: {'agent_ids': [{'node_type': 'node_type',
