...
from ...models.model_enable_network_tracer_req import ModelEnableNetworkTracerReq
from ...types import Response


def _get_kwargs(
    *,
    json_body: ModelEnableNetworkTracerReq,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/deepfence/network/tracer/enable",
        "json": json_json_body,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (ModelEnableNetworkTracerReq):  Example: {'agent_ids': [{'available_workload':
