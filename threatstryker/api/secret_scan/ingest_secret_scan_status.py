...
from ...models.ingesters_secret_scan_status import IngestersSecretScanStatus
from ...types import Response


def _get_kwargs(
    *,
    body: Union[None, list["IngestersSecretScanStatus"]],
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/deepfence/ingest/secret-scan-logs",
    }
